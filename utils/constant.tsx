...
export const SCREEN2XL_SIZE = 1900;
...
export const RECONNECT_WEBSOCKET = 1000*60*15;

// export const ETHWEB3WSS = new ethers.providers.WebSocketProvider(WSSETHRPC_URL);
// export const BNBWEB3WSS = new ethers.providers.WebSocketProvider(WSSBSCRPC_URL);

export const ETHWEB3HTTP = new Web3(ETHRPC_URL);
export const BNBWEB3HTTP = new Web3(BSCRPC_URL);

export const GELATO_ADDRESS = '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee';
...
export const WHITELIST_TOKENS ={
  ETH:{
    ...
    SRG: "0xcD682EF09d07668d49A8103ddD65Ff54AebFbfDe"
  },
  BSC:{
